...
public class TailoredConfigRequest {
     ...
     * @return boolean
     */
    public static TailoredConfigResponse tailoredConfig(String sn, String devToken, JLinkClient mJLinkClient) {
        TailoredConfigResponse response;
        String requestUrl = String.format("%s/%s/%s", JLinkDomain.OPENAPI_DOMAIN.get(), JLinkDeviceRequestUrl.TAILORED_CONFIG.get(), devToken);
