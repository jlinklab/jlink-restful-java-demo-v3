...
public class DeviceLocalPicRequest {
     ...
     * @return {@link String}
     */
    public String deviceLocalPic(String sn, String startTime, String endTime, String fileName, String devToken, JLinkClient mJLinkClient) {
        DeviceLocalPicResponse response;
        String requestUrl = String.format("%s/%s/%s", JLinkDomain.OPENAPI_DOMAIN.get(), JLinkDeviceRequestUrl.DEVICE_LOCAL_PIC.get(), devToken);
