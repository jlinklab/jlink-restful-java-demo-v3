 ...
 * @date 2025/03/11
 */
public class DetectPetDetectionConfig extends DeviceConfig {
    @SerializedName("Detect.PetDetection")
    protected List<DetectPetDetectionDTO> detectPetDetectionDTOS;
    /**
     * name
     */
    @SerializedName("Name")
    ...
    public List<DetectPetDetectionDTO> getDetectPetDetectionDTOS() {
        return detectPetDetectionDTOS;
    }

    public void setDetectPetDetectionDTOS(List<DetectPetDetectionDTO> detectPetDetectionDTOS) {
        this.detectPetDetectionDTOS = detectPetDetectionDTOS;
    }
    ...
    public static class DetectPetDetectionDTO {
        /**
         * dynamicTestingOpen
         */
