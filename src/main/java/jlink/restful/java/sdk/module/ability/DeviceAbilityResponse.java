    ...
    public static class DevAbility {
        ...
        public static class SystemFunctionDTO {
            ...
            public static class OtherFunctionDTO {
                ...
                @SerializedName("SupportCustomerFlowCount")
                private Boolean supportCustomerFlowCount;

                public Boolean getSupportCustomerFlowCount() {
                    return supportCustomerFlowCount;
                }

                public void setSupportCustomerFlowCount(Boolean supportCustomerFlowCount) {
                    this.supportCustomerFlowCount = supportCustomerFlowCount;
                }
