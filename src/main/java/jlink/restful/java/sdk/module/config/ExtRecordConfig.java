 ...
 * @date 2024/05/24
 */
public class ExtRecordConfig extends DeviceConfig {
    @SerializedName("ExtRecord")
    protected List<ExtRecordDTO> recordDTOS;
    /**
     * name
     */
    @SerializedName("Name")
    ...
    public List<ExtRecordDTO> getRecordDTOS() {
        return recordDTOS;
    }

    public void setRecordDTOS(List<ExtRecordDTO> recordDTOS) {
    ...
    public static class ExtRecordDTO {
        @SerializedName("Mask")
