...
public class DeviceAlarmListRequest {
     ...
     * @return boolean
     */
    public DeviceAlarmListResponse getDeviceAlarmList(String sn, String startTime, String endTime, String devToken, JLinkClient mJLinkClient) {
        DeviceAlarmListResponse response;
        String requestUrl = String.format("%s/%s/%s", JLinkDomain.OPENAPI_DOMAIN.get(), JLinkDeviceRequestUrl.CLOUD_ALARM_LIST.get(), devToken);
